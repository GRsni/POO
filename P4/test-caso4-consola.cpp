...
int main()
{
  ...
  cout << "\n" AZUL "---------------INVENTARIO DE EXISTENCIAS-----------" NORMAL "\nLIBROS: \n"
       << enrique_alfarero << '\n'
       << manualidades1 << '\n'
       << salem << '\n'
       << bracula
  ...
  cout << p5 << endl
       ...
       << "\n" AZUL "-------------------DETALLE DE PEDIDOS--------------" NORMAL "\n";
  pedido_art.mostrarDetallePedidos(cout);
  cout << "\n" AZUL "------------------VENTAS DE ARTÍCULOS--------------" NORMAL "\n";
  pedido_art.mostrarVentasArticulos(cout);

  cerr << "\n" AZUL "-----------------PRUEBAS DE EXCEPCIONES------------" NORMAL "\n";
  try
  {
